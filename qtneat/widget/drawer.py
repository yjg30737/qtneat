from qtpy.QtWidgets import QWidget, QGridLayout, QGraphicsOpacityEffect, qApp, QMainWindow
from qtpy.QtCore import Qt, QPropertyAnimation, QAbstractAnimation, QParallelAnimationGroup
